> **Historical record.** This is the 2026-07-05 audit, executed and closed out on 2026-07-13. It is superseded by later fixes (see the 2026-09-03 audit and its commit) — treat details below (Groq, dataset schema, etc.) as a snapshot, not current state.
